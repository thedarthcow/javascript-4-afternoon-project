...
var movie1 = new Movie("Ace Ventura", "Comedy", 4);


// Code here

Movie.prototype.changeRating = function (newRating) {
  //Set new property called newRating
...
User.prototype.addSavedPost = function (postId, postTitle, postRating) {
  let newPost = {
    id: postId,
    title: postTitle,
    rating: postRating
